...
/// <summary>
/// Represents a dynamic property of <see cref="CsvMapping"/> ("late binding") for processing CSV files with header row.
/// </summary>
...
internal sealed class ColumnNameProperty<T> : SingleColumnProperty<T>, ICloneable
{
    ...
    /// <summary>
    /// Collection of alternative column names of the CSV file, which is used by <see cref="CsvMapping"/> to access
