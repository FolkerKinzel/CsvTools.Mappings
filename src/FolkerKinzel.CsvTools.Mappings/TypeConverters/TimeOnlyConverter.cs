...
public sealed class TimeOnlyConverter : TypeConverter<TimeOnly>, ILocalizable
{
    ...
    /// <see cref="TimeOnly"/> values. If <paramref name="format"/> is not <c>null</c>, this
    /// format string is also used for parsing. The accepted standard formats are 
    /// 'r', 'R', 'o', 'O', 't' and 'T'. </param>
    /// <param name="styles">
    ...
    /// property.</param>
    /// 
    /// <exception cref="ArgumentOutOfRangeException">The value of <paramref name="styles"/> is invalid.
    /// </exception>
    public TimeOnlyConverter(IFormatProvider? formatProvider = null,
    ...
    /// <para>The length of <see cref="Format"/> is 1, and it is not one of the standard format
    /// specifier characters defined for <see cref="TimeOnly"/> ('r', 'R', 'o', 'O', 't' or 'T').
    /// </para>
    /// <para>-or-</para>
