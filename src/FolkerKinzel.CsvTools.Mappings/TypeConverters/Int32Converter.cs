...
/// </summary>
public sealed class Int32Converter 
    : TypeConverter<int>, IHexConverter<int>, ILocalizable, IAsHexConverter
{
    ...
    /// </param>
    /// <param name="format">
    /// A format string that is used for the <see cref="string"/> output of <see cref="int"/>
