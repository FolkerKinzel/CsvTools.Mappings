...
public sealed class TimeSpanConverter : TypeConverter<TimeSpan>, ILocalizable
{
    ...
    /// <see cref="TimeSpan"/> values. If the option <paramref name="parseExact"/> is selected 
    ...
    /// </param>
    /// <param name="styles">
    /// A value of the <see cref="TimeSpanStyles"/> enum that provides additional information 
    /// for parsing. (Becomes evaluated only if <paramref name="parseExact"/> is <c>true</c>.)
    /// </param>
    ...
    /// invalid and <paramref name="parseExact"/> is <c>true</c>.</exception>
    public TimeSpanConverter(IFormatProvider? formatProvider = null,
    ...
    /// <summary>
    /// Gets a value of the <see cref="TimeSpanStyles"/> enum that provides additional
    /// information for parsing.
    /// </summary>
    public TimeSpanStyles Styles { get; }

    /// <summary>
    /// Gets a value indicating whether the text in the CSV file must exactly match the 
    /// format determined with <see cref="Format"/>.
    /// </summary>
