...
/// </summary>
[CLSCompliant(false)]
public sealed class UInt32Converter
    : TypeConverter<uint>, IHexConverter<uint>, ILocalizable, IAsHexConverter
{
    ...
    /// </param>
    /// <param name="format">
    /// A format string that is used for the <see cref="string"/> output of <see cref="uint"/>
