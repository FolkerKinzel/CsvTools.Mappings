...
/// </summary>
[CLSCompliant(false)]
public sealed class UInt16Converter : TypeConverter<ushort>, IHexConverter<ushort>, ILocalizable
{
    ...
    /// </param>
    /// <param name="format">
    /// A format string that is used for the <see cref="string"/> output of <see cref="ushort"/> values.
